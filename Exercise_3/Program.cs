...
namespace ExerciseThree{
    class Program{
        ...
        public static void Main(string[] args){
            ...
            //     Console.WriteLine($"Input fee{i+1}: ");
            //     int fee=Convert.ToInt32(Console.ReadLine());
            //     Console.WriteLine($"Input working hours{i+1}: ");
            //     int workinghours=Convert.ToInt32(Console.ReadLine());
            //     Console.WriteLine($"Input working Name{i+1}: ");
            //     string name=Console.ReadLine();
            //     Teacher teacher=new Teacher(fee,name,workinghours);    
            //     teachers.Add(teacher);

            // }
            // for (int i = 0; i < 5; i++)
            // {
            //     Console.WriteLine($"{teachers[i].GetResult()}");
            // }
            // With Recursive 
            //===================
